...
const generateCourseCard = async (course, parent) => {
    ...
    // Navigating to course detail page.
    newCourse.addEventListener('click', () => {
        // sessionStorage.setItem('selectedCourse', JSON.stringify(newCourse)); // Here, as newCourse is dom element it cant be serialized to JSON [JSON.stringify() cannot properly serialize DOM elements] = empty
